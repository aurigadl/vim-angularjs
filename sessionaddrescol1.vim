...
set backupdir=~/.tmpvim/swap
set copyindent
set directory=~/.tmpvim/backup
set expandtab
...
set shortmess=aoO
badd +63 run.py
badd +5 templates/show_entries.html
badd +1 addressCol.py
args run.py
edit addressCol.py
...
44
normal! zo
let s:l = 65 - ((22 * winheight(0) + 20) / 40)
...
wincmd w
argglobal
edit templates/show_entries.html
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <BS> =AutoPairsDelete()
inoremap <buffer> <silent> î :call AutoPairsJump()a
